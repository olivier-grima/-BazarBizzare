...
def sapinf(p,x,y,couleurf1,couleurf2,couleurf3):       #sapin(1,0,0,"sea green")
    ...
    dessinePolygone(3,lCote,x,y,couleurf1)                #faire un triangle
    dessinePolygone(3,lCote,x,y+(lCote/4),couleurf2)      #faire une deuxième triangle
    dessinePolygone(3,lCote,x,y+(lCote/2),couleurf3)      #faire un troisième triangle
